...
const ATLETAS = [
  ...
  { slug:'vitor-jovino',    nome:'Vitor Jovino',    posicao:'Atacante',         altura:'1,83 m', ano:'2008', clube:'Boston City FC',        exClube:'Grêmio Prudente',  carta:'3.jpg', foto:'vitor.jpeg' },
  ...
  { slug:'lucas-moraes',    nome:'Lucas Moraes',    posicao:'Lateral-esquerdo', clube:'Mirassol',            categoria:'Sub-17' },
  { slug:'joao-alexandre',  nome:'João Alexandre',  posicao:'Meio-campo',       clube:'Cruzeiro',            categoria:'Sub-11', foto:'joao-alexandre.jpeg' },
  { slug:'heytor',          nome:'Heytor',          posicao:'Meio-campo',       clube:'Atlético Goianiense', categoria:'Sub-12', foto:'heytor.jpeg' },
];
